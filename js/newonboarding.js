...
function form1() {
    ...
    localStorage.getItem("forName") !== null && localStorage.removeItem("forName");
    localStorage.getItem("purpose") !== null && localStorage.removeItem("purpose");
    localStorage.getItem("phoneNumber") !== null && localStorage.removeItem("phoneNumber");
    ...
    document.getElementById("onboard-form-container").style = "display:flex;flex-direction:column;";
...
function form3() {
    ...
    const forWish = [`Best Wishes For ${name.split(" ")[0]}`, `Wish ${name.split(" ")[0]} a Happy Birthday`, `Motivate ${name.split(" ")[0]}`];
    div.style.display = "flex";
    div.style.flexDirection = "column";
    div.style.margin = "12px 10px";
    for (let text of forWish) {
...
function form4() {
    ...
    div2.style = "display:flex;justify-content:flex-start;align-items:center;flex-direction:row !important;width:100%;border:1px solid red ;border-radius:8px;margin-bottom 8px;height:46px;border:1px solid rgb(150, 144, 232)";
    ...
    input.style = "height: 38px;padding: 16px 20px;background-color:transparent; border : 0;color:white;width :80%;";
    ...
    div3.style = "display: flex ;align-items:center;gap:10px;flex-direction:row !important;justify-content:start; padding-left:10px";
